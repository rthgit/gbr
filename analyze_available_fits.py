#!/usr/bin/env python3
"""
ANALYZE AVAILABLE FITS FILES
============================

Analizza i file FITS reali disponibili per effetti QG.
...
def analyze_available_fits():
    """
    Analizza tutti i file FITS disponibili
    """
    print("🚀 ANALYZE AVAILABLE FITS FILES")
    print("=" * 60)
    ...
    fits_files = [
        ...
        'L251020164901F357373F96_EV00.fits',
        'L25102020315294ADC46894_PH00.fits'
    ]
