#!/usr/bin/env python3
"""
🚀 CREA HTML COMPRENSIVO CON IMMAGINI
Genera un HTML completo del paper con tutte le immagini integrate
"""
...
def create_comprehensive_html():
    """Crea HTML completo con immagini integrate"""
    
    print("🚀 CREANDO HTML COMPRENSIVO CON IMMAGINI...")
    print("=" * 60)
    
    # Leggi il contenuto del paper
    with open('COMPREHENSIVE_QUANTUM_GRAVITY_PAPER.md', 'r', encoding='utf-8') as f:
...
<body>
    ...
    <div class="content">
        <div class="abstract">
            ...
            <div class="key-findings">
                ...
                <ul>
                    ...
                    <li>2 GRBs with strong signals (≥5σ): L251021110739F357373F39 (10.18σ) and L251021110325F357373F43 (5.21σ)</li>
                    <li>2 GRBs with significant signals (3-5σ): L251021110134F357373F33 (3.36σ) and L251021110034F357373F27 (3.18σ)</li>
                    <li>1 GRB with marginal signal (2-3σ): L251021105813F357373F65 (2.28σ)</li>
        ...
        <p><strong>Keywords</strong>: Quantum Gravity, Gamma Ray Bursts, Fermi-LAT, Spacetime, Planck Scale</p>
...
"""
    ...
    # Salva l'HTML
    with open('COMPREHENSIVE_QUANTUM_GRAVITY_PAPER.html', 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    print("✅ HTML COMPRENSIVO CREATO!")
    print("📁 File: COMPREHENSIVE_QUANTUM_GRAVITY_PAPER.html")
    print("🎨 Include tutte le immagini integrate")
