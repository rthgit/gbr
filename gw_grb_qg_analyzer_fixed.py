#!/usr/bin/env python3
"""
GRAVITATIONAL WAVE + GRB QG ANALYZER - FIXED
============================================

Analisi temporale GW170817 + GRB170817A per effetti QG multi-messenger.
Versione corretta senza errori di plotting.
...
def quick_gw_grb_analysis():
    """
    Analisi rapida GW+GRB per effetti QG
    """
    print("🔬 GRAVITATIONAL WAVE + GRB QG ANALYZER - FIXED")
    print("=" * 60)
    ...
    gw_data = load_ligo_gw170817_data()
    grb_data = load_fermi_grb170817a_data()
...
def load_fermi_grb170817a_data():
    """
...
def save_gw_grb_results(gw_grb_results, grb_results):
    ...
    with open('gw_grb_qg_results_fixed.json', 'w') as f:
    ...
    df_summary.to_csv('gw_grb_qg_summary_fixed.csv', index=False)
    
    print("✅ Results saved: gw_grb_qg_results_fixed.json, gw_grb_qg_summary_fixed.csv")

if __name__ == "__main__":
    quick_gw_grb_analysis()
