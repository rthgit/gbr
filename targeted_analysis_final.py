#!/usr/bin/env python3
"""
TARGETED ANALYSIS FINAL - No Unicode
...
def load_and_filter_top_candidates():
    ...
    if len(top_candidates) > 0:
        ...
        print(f"  - Max significance: {top_candidates['Significance_Sigma'].max():.2f} sigma")
...
def analyze_enhanced_results(enhanced_results):
    ...
    print(f"  - Original mean: {df_enhanced['original_significance'].mean():.2f} sigma")
    print(f"  - Enhanced mean: {df_enhanced['max_significance'].mean():.2f} sigma")
    print(f"  - Original max: {df_enhanced['original_significance'].max():.2f} sigma")
    print(f"  - Enhanced max: {df_enhanced['max_significance'].max():.2f} sigma")
    ...
    print(f"  - Original >3sigma: {orig_above_3sigma}")
    print(f"  - Enhanced >3sigma: {enhanced_above_3sigma}")
    print(f"  - Original >5sigma: {orig_above_5sigma}")
    print(f"  - Enhanced >5sigma: {enhanced_above_5sigma}")
    print(f"  - Original >10sigma: {orig_above_10sigma}")
    print(f"  - Enhanced >10sigma: {enhanced_above_10sigma}")
    ...
    for i, (_, row) in enumerate(top_enhanced.iterrows()):
        ...
        print(f"  {i+1}. {row['source_id']} ({qg_status}) - {row['original_significance']:.2f} -> {row['max_significance']:.2f} (+{improvement:.2f}) [{row['max_technique']}]")
...
def main():
    ...
    print(f"  Enhanced: mean={report['enhanced_significance']['mean']:.2f}sigma, max={report['enhanced_significance']['max']:.2f}sigma")
    
    print(f"\nThreshold improvements:")
    print(f"  >3sigma: {report['original_significance']['above_3sigma']} -> {report['enhanced_significance']['above_3sigma']}")
    print(f"  >5sigma: {report['original_significance']['above_5sigma']} -> {report['enhanced_significance']['above_5sigma']}")
    print(f"  >10sigma: {report['original_significance']['above_10sigma']} -> {report['enhanced_significance']['above_10sigma']}")
